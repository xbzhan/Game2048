 ...
 */
public class Game4x4Activity extends ActionBarActivity {
    ...
    private Button introduction4x4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_4x4game);
        gameview=(GridLayout)findViewById(R.id.gameView);
        tvScore=(TextView)findViewById(R.id.tvscore);
        start=(Button)findViewById(R.id.Start);
        restart=(Button)findViewById(R.id.Restart);
        introduction4x4=(Button)findViewById(R.id.Introduce);
        //根据不同手机分辨率设置5*5方阵
        setLayoutSize();
        //设置音效
        ...
        introduction4x4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Game4x4Activity.this,IntroductionActiviy5x5.class);
